...
document.getElementById('knifeCost').in.nerHTML = knifeCost; 
var nextcost4 = Math.floor(200*Math.pow(1.1,vents));
document.getElementById('ventCost').innerHTML = nextcost4;
  }else{
