...
saveGame();
document.getElementById('notifs').innerHTML = "game saved!";
 }, 10000);

 setInterval(function(){
  document.getElementById('prestigeCost').innerHTML = json.stringify(prestigeCost);
  document.getElementById('kills').innerHTML = json.stringify(kills);
  document.getElementById('ventCost').innerHTML = json.stringify(ventCost);
  document.getElementById('vents').innerHTML = json.stringify(vents);  
  document.getElementById('imposter').innerHTML = json.stringify(imposter);
  document.getElementById('knives').innerHTML = json.stringify(knives);
  document.getElementById('guns').innerHTML = json.stringify(guns); 
  document.getElementById('gunCost').innerHTML = json.stringify(gunCost);
  document.getElementById('knifeCost').innerHTML = json.stringify(knifeCost); 
 });
